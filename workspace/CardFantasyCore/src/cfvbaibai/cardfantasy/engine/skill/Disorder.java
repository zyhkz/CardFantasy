...
public final class Disorder {
    public static DeadType apply(SkillUseInfo skillUseInfo, SkillResolver resolver, CardInfo card,Player defenderHero,EntityInfo attacker, Skill killSkill) throws HeroDieSignal {
