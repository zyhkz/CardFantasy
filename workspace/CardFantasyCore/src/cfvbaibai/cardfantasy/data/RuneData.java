...
public enum RuneData {
    ...
    冥途("", RuneClass.GROUND, 4, SkillType.圣炎, 0, 0, 5, Growth.RUNE, RuneActivator.enemyGrave(1, null)),
    ...
    鬼面("", RuneClass.FIRE, 5, SkillType.虚无, 1, 1, 5, Growth.RUNE, RuneActivator.enemyField(3, null)),
    ;
