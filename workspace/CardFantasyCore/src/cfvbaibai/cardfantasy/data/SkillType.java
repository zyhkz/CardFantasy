...
public enum SkillType {
    ...
    /* 攻击力削弱技能 */
    削弱(10, SkillTag.永久, SkillTag.基础攻击加成, SkillTag.抗不屈),
    缴械(80, SkillTag.永久, SkillTag.基础攻击加成, SkillTag.抗不屈),
    群体削弱(5, SkillTag.永久, SkillTag.基础攻击加成, SkillTag.抗不屈),
     ...
     */
    献祭(20, 10, SkillTag.永久, SkillTag.基础攻击加成),
    ...
    嗜血(10, SkillTag.永久, SkillTag.基础攻击加成),
    透支(20, SkillTag.永久, SkillTag.基础攻击加成),
    力竭(800,0),
    过载(20, 30, SkillTag.永久, SkillTag.基础攻击加成),
    ...
    森林之力(25, SkillTag.基础攻击加成, SkillTag.抗削弱),
    地狱之力(25, SkillTag.基础攻击加成, SkillTag.抗削弱),
    蛮荒之力(25, SkillTag.基础攻击加成, SkillTag.抗削弱),
    王国之力(25, SkillTag.基础攻击加成, SkillTag.抗削弱),
    本源之力(20, SkillTag.基础攻击加成, SkillTag.抗削弱),
    ...
    圣光(15, 15, SkillTag.额外攻击加成),
    要害(15, 15, SkillTag.额外攻击加成),
    ...
    连锁攻击(0, 25, SkillTag.额外攻击加成, SkillTag.抗免疫, SkillTag.物理攻击),
    高级连击(0, 0,4,0, SkillTag.抗免疫, SkillTag.物理攻击),
    女武神之辉(200, 0, SkillTag.额外攻击加成, SkillTag.抗免疫, SkillTag.物理攻击),
    趁胜追击(40, 10, SkillTag.独立攻击加成),
    背刺(40, SkillTag.独立攻击加成),
    大背刺(2000,0, SkillTag.独立攻击加成),
    潜伏之力(1500,0, SkillTag.独立攻击加成),
    深海之力(1200,0, SkillTag.独立攻击加成),
    突击(1500,0, SkillTag.独立攻击加成),
    复仇(40, 10, SkillTag.独立攻击加成),
    振奋(40, 10, SkillTag.独立攻击加成),
    ...
    迷雾滋养(2000, 0, SkillTag.额外攻击加成),
    生命汲取(70, 0, SkillTag.额外攻击加成),
    良驹(0, SkillTag.额外攻击加成),
    死亡女神(0, SkillTag.额外攻击加成,SkillTag.抗夺魂),

    虚弱(0, SkillTag.额外攻击加成, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.魔王无效, SkillTag.魔族天赋),
    战争怒吼(0, SkillTag.额外攻击加成, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.魔王无效, SkillTag.魔族天赋),
    ...
    /* HP 上限调整技能  */
    王国守护(50,SkillTag.抗毒刃),
    蛮荒守护(50,SkillTag.抗毒刃),
    ...
    焰火改造(1000,0,5000,0,SkillTag.抗毒刃),
    不灭之志(500,0,3500,0,SkillTag.抗毒刃),
    成长(300,0,6000,0,SkillTag.抗毒刃),
    金刚不坏之躯(2500,0,20000,0,SkillTag.抗毒刃, SkillTag.永久, SkillTag.基础攻击加成),
    神魔附体(1000,0,20000,0,SkillTag.抗毒刃, SkillTag.永久, SkillTag.基础攻击加成),
    偶像演出(50,0, SkillTag.抗毒刃, SkillTag.基础攻击加成,SkillTag.抗削弱),

    森之助生命(30,0,SkillTag.抗毒刃),
    森之助攻击(15,0, SkillTag.基础攻击加成,SkillTag.抗削弱),

    松鼠守护(2000,0, SkillTag.抗毒刃),
    ...
    毁灭之翼(700,0,1200,0, SkillTag.魔法,SkillTag.法术扼杀),
    ...
    法术灭杀(2500,0,2500,0, SkillTag.魔法,SkillTag.法术扼杀),
    ...
    三狙击 (0, 0, 600,0, SkillTag.抗免疫, SkillTag.狙击),
    爆头狙击 (0, 0,1800,0, SkillTag.抗免疫, SkillTag.狙击),
    穿云箭(0, 0, 1200,0, SkillTag.抗免疫, SkillTag.狙击),
    弹无虚发(0, 0, 1200,0, SkillTag.抗免疫, SkillTag.狙击),
    先锋突袭(0, 0, 3000,0, SkillTag.抗免疫, SkillTag.狙击),
    完美狙击(0, 0, 3000,0, SkillTag.抗免疫, SkillTag.狙击),
    精准狙击(0, 0, 2000,0, SkillTag.抗免疫, SkillTag.狙击),
    鬼神乱舞(6, 0, 1700,0, SkillTag.抗免疫, SkillTag.狙击),
    掠影(0, 0, 1200,0, SkillTag.抗免疫, SkillTag.狙击),
    异端裁决(0, 0, 1800,0, SkillTag.抗免疫, SkillTag.狙击),
    厄运枪狙击(0, 0, 1200,0, SkillTag.抗免疫, SkillTag.狙击),
    绯弹(0, 0, 800,0, SkillTag.抗免疫, SkillTag.狙击),
    左轮射击(0, 0,1200,0, SkillTag.抗免疫, SkillTag.狙击),
    ...
    二重狙击(0, 0, 0,25, SkillTag.抗免疫, SkillTag.狙击),
    神箭三重奏(0, 0, new int[] { 220, 250, 270, 300, 320, 350, 370, 400, 420, 450, 500 }, SkillTag.抗免疫, SkillTag.狙击),
    猎杀时刻(0, 0, 800,0, SkillTag.抗免疫, SkillTag.狙击),
    寒莹触碰(50, 0, 750,0, SkillTag.抗免疫, SkillTag.狙击),
    武形神箭(0, 0, new int[] { 220, 250, 270, 300, 320, 350, 370, 400, 420, 450, 500 }, SkillTag.抗免疫, SkillTag.狙击),
    一刀斩(0, 0, 1500,0, SkillTag.抗免疫, SkillTag.狙击),
    射门(0, 0, 200,0, SkillTag.抗免疫, SkillTag.狙击),
    魔力飞刃 (0, 0, 600,0, SkillTag.抗免疫, SkillTag.狙击),
    百发百中(0, 0, 1500,0, SkillTag.抗免疫, SkillTag.狙击),
    追风利刃(0, 0,1200,0, SkillTag.抗免疫, SkillTag.狙击),

    穿刺(15, SkillTag.抗免疫),
    精准打击(100, 10, SkillTag.抗免疫),
    精准射击(250, 0, SkillTag.抗免疫),
    一夫之勇(120,0, SkillTag.额外攻击加成, SkillTag.抗免疫,SkillTag.抗夺魂),
    ...
    反击(20, SkillTag.抗免疫, SkillTag.反击),
    ...
    守护(10, SkillTag.守护),
    神之守护(0, SkillTag.守护),
    天官帝君(0,SkillTag.抗沉默, SkillTag.守护),
    否决(3,0),
    ...
    酒池肉林(70,0),
    永劫深渊(40,0),
    辰星之子(50,0,SkillTag.抗沉默),
    叫阵(0,0,SkillTag.抗沉默),
    蔑视(0,SkillTag.抗沉默),
    月之潮汐(12, 0,SkillTag.抗夺魂),
    光耀晨星(15, 0),

    横扫(0, SkillTag.抗免疫, SkillTag.物理攻击),
    三千世界(0, SkillTag.抗免疫, SkillTag.物理攻击),
    巨斧横扫(100,0, SkillTag.额外攻击加成,SkillTag.抗免疫, SkillTag.物理攻击),
    ...
    盾刺(20, SkillTag.抗免疫, SkillTag.反击),
    荆棘术(160, 40, SkillTag.抗免疫, SkillTag.反击),
    ...
    裂伤(0, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.魔王无效),
    ...
    冥界召唤(0),
    画境相通(0),
    睹物思人(3,0,SkillType.画境相通,0,null,0,SkillTag.召唤),
    顽疾(1,0),
    ...
    传送(0, SkillTag.即死),
    胜者为王(0, SkillTag.即死),
    万里追魂(0, SkillTag.即死, SkillTag.不动),
    ...
    冥狱鞭挞(0, 0,3,0, SkillTag.抗沉默,SkillTag.抗免疫, SkillTag.物理攻击),
    ...
    盘踞之物(0,0,2,0, SkillTag.抗免疫, SkillTag.物理攻击),
    二段斩(70,0,1,0, SkillTag.抗免疫, SkillTag.物理攻击),
    二段斩强袭(70,0,1,0, SkillTag.抗免疫, SkillTag.物理攻击,SkillTag.不动),
    巨象猛冲(-300, 0,2,0, SkillTag.永久, SkillTag.基础攻击加成, SkillTag.抗免疫, SkillTag.物理攻击),
    精武(100,0,2,0, SkillTag.抗免疫, SkillTag.物理攻击),

    灵巧(0),
    灵魂禁锢(0),
    沉默(0, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.沉默, SkillTag.魔王无效, SkillTag.魔族天赋),
    沉默领域(0, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.沉默, SkillTag.魔王无效, SkillTag.魔族天赋),
    觉醒沉默(0, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.沉默, SkillTag.魔王无效, SkillTag.魔族天赋),
    觉醒沉默A(0, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.沉默, SkillTag.魔王无效, SkillTag.魔族天赋),
    ...
    贪狼(0, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.沉默, SkillTag.魔王无效, SkillTag.魔族天赋),
    ...
    毁灭之力(101,0,99999,0, SkillType.半数沉默,0,null,0,SkillTag.魔法, SkillTag.魔王无效),
    ...
    灵魂净化(0, SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.魔王无效, SkillTag.魔族天赋),
    ...
    号角(1),
    集结旗帜(1,SkillTag.不动),
    竹影婆娑(1,0,SkillTag.不动),
    冲浪集结(2,0),
    下自成蹊(2,0),
    进军之令(5,0),
    上层精灵的挽歌(2, 0),
    迷魂(30, 5, SkillTag.控制, SkillTag.魔王无效),
    ...
    王国之盾(15, 5, SkillTag.种族之盾),
    森林之盾(15, 5, SkillTag.种族之盾),
    ...
    觉醒灵王的轰击(250, 50, 3, 0, SkillTag.抗免疫),
    ...
    破魔(800, 0, 3, 0, SkillTag.抗免疫),
    寒冰触碰(250, 50, 3, 0, SkillTag.抗免疫),
    寒霜之心(700, 0, 3, 0, SkillTag.抗免疫),
    冰刃(450, 0, 3, 0, SkillTag.抗免疫),
    寒霜之指(500, 0, 3, 0, SkillTag.抗免疫),
    霜火(550, 0, 3, 0, SkillTag.抗免疫),
    ...
    魔力碎片(400, 0, 3, 0, SkillTag.抗免疫),
    雷霆一击(200, 50, 3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    雷公助我(450, 0, 3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    雷霆之怒(200, 50, 3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    三昧真火(600, 0, 3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    天神下凡(2500, 0, 1, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    薜荔之怒(800, 0, 2, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    雷切(400,0,3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    麻痹药剂(100,0,3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    正义裁决(550, 0, 3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    圣翼裁决(0, 0, 1, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),
    放逐之雷(700, 0, 3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),

    彻骨之寒(600, 0, 3, 0, SkillTag.抗免疫),
    凛冬将至(300, 0, 3, 0, SkillTag.抗免疫),

    大地之盾(0, SkillTag.控制, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.魔族天赋),
    ...
    空城(0,0),
    沐浴龙血(0),
    时光倒流(0, 0, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.新生),
    ...
    灵力魔阵(150,0),
    阳式阴式(900,0),
    乱流(3, 0, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.即死),
    上挑(2, 0, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.即死),
    故技重演(9, 0, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.即死),
    ...
    镜像(0, 0, SkillTag.召唤),
    复仇之影(0, 0, SkillTag.召唤),
    洛神(0, 0, SkillTag.召唤),
    召唤王国战士(0, 0, SkillTag.召唤),
    召唤骷髅战士(0, 0, SkillTag.召唤),
    召唤邪龙护卫(0, 0, SkillTag.召唤),
    召唤噩梦护卫(0, 0, SkillTag.召唤),
    召唤复仇护卫(0, 0, SkillTag.召唤),
    召唤花仙子(0, 0, SkillTag.召唤),
    召唤火焰乌鸦(0, 0, SkillTag.召唤),
    召唤人马巡逻者(0, 0, SkillTag.召唤),
    召唤女神侍者(0, 0, SkillTag.召唤),
    召唤树人守护者(0, 0, SkillTag.召唤),
    召唤炎魔(0, 0, SkillTag.召唤),
    双子之身(0, 0, SkillTag.召唤),
    召唤北海神兽(0, 0, SkillTag.召唤),
    召唤梦境女神(0, 0, SkillTag.召唤),
    酋长号令(0, 0, SkillTag.召唤),
    召唤花族守卫(0, 0, SkillTag.召唤),
    原召唤花族守卫(0, 0, SkillTag.召唤),
    召唤花族侍卫(0, 0, SkillTag.召唤),
    原召唤花族侍卫(0, 0, SkillTag.召唤),
    七十二变(0, 0, SkillTag.召唤),
    英灵降临(0, 0, SkillTag.召唤),
    寒霜召唤(0, 0, SkillTag.召唤),
    原寒霜召唤(0, 0, SkillTag.召唤),
    星之所在(0, 0, SkillTag.召唤),
    灵龙轰咆(0, 0, SkillTag.召唤),
    无尽梦魇(0, 0, SkillTag.召唤),
    百鬼夜行(0, 0, SkillTag.召唤),
    武形降临(0, 0, SkillTag.召唤),
    万兽奔腾(0, 0, SkillTag.召唤),
    爱之召唤(0, 0, SkillTag.召唤),
    仙子召唤(0, 0, SkillTag.召唤),
    召唤炮灰(0, 0, SkillTag.召唤),
    召唤孔明(0, 0, SkillTag.召唤),
    召唤花舞剑士(0, 0, SkillTag.召唤),
    召唤玫瑰甜心(0, 0, SkillTag.召唤),
    召唤伍长(0, 0, SkillTag.召唤),
    召唤兵长(0, 0, SkillTag.召唤),
    召唤合金伍长(0, 0, SkillTag.召唤),
    召唤合金兵长(0, 0, SkillTag.召唤),
    突击军势(SkillType.召唤伍长,0, SkillType.召唤兵长,0,SkillTag.召唤),
    突击军阵(SkillType.召唤合金伍长,0, SkillType.召唤合金兵长,0,SkillTag.召唤),
    召唤玫瑰剑士(SkillType.召唤花舞剑士,0, SkillType.召唤玫瑰甜心,0,SkillTag.召唤),
    东方英魂(0, 0, SkillTag.召唤),
    西方英灵(0, 0, SkillTag.召唤),
    魔力彩蛋(SkillType.东方英魂,0, SkillType.西方英灵,0,SkillTag.召唤),
    播种(0, 0, SkillTag.召唤),
    收获(0, 0, SkillTag.召唤),
    疯长的植物(SkillType.播种,0, SkillType.收获,0,SkillTag.召唤),
    剑道(0,0,SkillTag.召唤),
    桃园结义(0, 0, SkillTag.召唤),
    白帝托孤(0, 0, SkillTag.召唤),
    灵龟羁绊(0, 0, SkillTag.召唤),
    法师契约(0, 0, SkillTag.召唤),
    圣堂召唤(0, 0, SkillTag.召唤),
    圣德同伴(0, 0, SkillTag.召唤),
    森林的梦幻(0, 0, SkillTag.召唤),
    育龙者(0, 0, SkillTag.召唤),
    召唤小黑(0, 0, SkillTag.召唤),
    三国英才(0, 0, SkillTag.召唤),
    三国武魂(0, 0, SkillTag.召唤),
    繁星(0, 0, SkillTag.召唤),
    星河召唤(0, 0,SkillTag.召唤),
    樱色轮舞(0, 0,SkillTag.召唤),
    月影分身(0,0, SkillTag.召唤),
    召唤圣诞雪人(0,0, SkillTag.召唤),
    圣诞狂欢(0,0, SkillTag.召唤),
    大地召唤(0,0, SkillTag.召唤),
    禁术召唤(0, 0, SkillTag.召唤),
    进攻号令(0, 0, SkillTag.召唤),
    页游纯洁(0, 0, SkillTag.召唤),
    樱蝶重生(0, 0, SkillTag.召唤),
    魔化冥蝶(0, 0, SkillTag.召唤),
    原素召唤(0, 0, SkillTag.召唤),
    页游星之所在(0, 0, SkillTag.召唤),
    噩梦马戏团(0, 0, SkillTag.召唤),
    原星之所在(0, 0, SkillTag.召唤),
    猫神的低语(0,0,SkillTag.召唤),
    乱世红颜(0,0,SkillTag.召唤),
    伎町迷影(0,0,SkillTag.召唤),
    三位一体(0,0,SkillTag.召唤),
    迷影森森(0,0,SkillTag.召唤),
    复仇亡灵(0,0),
    化鹏(0,0,SkillTag.召唤),
    审判之姿(0,0,SkillTag.召唤),
    混乱之源(0,0,SkillTag.召唤),
    狂野之怒(0,0,SkillTag.召唤),
    幻化(0,0,SkillTag.召唤,SkillTag.不动),
    虚实(-2,0,SkillTag.魔王无效,SkillTag.抗免疫,SkillTag.召唤),
    毅重(0,0,SkillTag.召唤,SkillTag.抗沉默),
    碎裂幻像(0,0,SkillTag.召唤,SkillTag.抗沉默),
    绝境重生(0,0,SkillTag.召唤),
    幽魂铁骑(0,0,SkillTag.召唤),
    反间(3000, 0, SkillTag.魔王无效,SkillTag.召唤),
    意外的挖掘(0, 0, SkillTag.召唤),
    海滨乐园(0,0,SkillTag.召唤),
    号令三军(0,0,SkillTag.召唤),
    如影随形(0,0,SkillTag.召唤),
    幽冥暗影(0,0,SkillTag.召唤),
    ...
    幻影奇袭(4,0,60,0),
    幻象幽灵(2,0,100,0),
    圣翼军团(4,0,70,0,SkillTag.复活),
    王国卫士(2,0,70,0),
    血之眷顾(3,0,80,0),
    深海幻影(4,0,80,0),
    蛇影重重(3,0,85,0),
    幻影斩 (3,0,80,0, SkillTag.即死),
    护身(1,0,100,0),
    快速增值(3,0,90,0),

    英魂唤醒(0,0,SkillTag.召唤,SkillTag.不动),
    英魂召集(0,0,SkillTag.召唤,SkillTag.不动),
    英灵召唤(SkillType.英魂唤醒,0, SkillType.英魂召集,0,SkillTag.召唤),
    幻影(0,0,SkillTag.召唤),
    星座能量掌握(0,0,SkillTag.召唤,SkillTag.基础攻击加成, SkillTag.抗削弱,SkillTag.抗毒刃),
    日光浴(0, 0, SkillTag.召唤,SkillTag.不动),
    终焉之兆(0,SkillTag.魔王无效,SkillTag.抗免疫, SkillTag.召唤),
    熔岩分身(0, 0, SkillTag.召唤),

    月之召唤(5,0,100,0,SkillTag.召唤),
    龙城之志(2,0,100,0,SkillTag.召唤),
    ...
    龙魂召唤(5,0,100,0,SkillTag.召唤),

    特殊体质(0,0,SkillTag.召唤),
    月之暗面(5,0,100,0,SkillTag.召唤),
    余香(5,0,100,0,SkillTag.召唤),
    护主(40,0,SkillTag.沉默无效,SkillTag.召唤),
    黑暗之门(0, 0, SkillTag.召唤),
    召唤契约(0,0,SkillTag.召唤),
    ...
    蛮荒威压(2, 0, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.魔族天赋),
    地狱同化(3, 0, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.魔族天赋),
    魔王降临(4, 0, SkillTag.抗免疫, SkillTag.魔王无效),
    ...
    军团王国之力(0, 3, SkillTag.永久, SkillTag.原始攻击加成, SkillTag.原始体力加成),
    军团森林之力(0, 3, SkillTag.永久, SkillTag.原始攻击加成, SkillTag.原始体力加成),
    军团蛮荒之力(0, 3, SkillTag.永久, SkillTag.原始攻击加成, SkillTag.原始体力加成),
    军团地狱之力(0, 3, SkillTag.永久, SkillTag.原始攻击加成, SkillTag.原始体力加成),
    军团魔神之力(0),
    军团萌货之力(0),
    原始攻击调整(0, 1, SkillTag.永久, SkillTag.原始攻击加成),
    原始体力调整(0, 1, SkillTag.永久, SkillTag.原始体力加成),
    ...
    画境铁壁(55,0,SkillTag.沉默无效),
    国之坚壁(6,0,SkillType.祈福,7,null,0,SkillTag.沉默无效),

    魔神之刃(0, 0, new int[] { 1000, 1000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000 }, SkillTag.抗免疫, SkillTag.狙击),
    魔神之甲(0, 500, SkillTag.抗免疫, SkillTag.反击),
    ...
    自动扣血(0, 0, SkillTag.抗守护),
    背水(110, 0,SkillTag.沉默无效),
    未知(0),
    良禽择木(50, 0,SkillTag.沉默无效),
    反向溅射(45, 0,SkillTag.沉默无效),
    画境乾坤(45, 0,SkillType.画境铁壁,0,null,0,SkillTag.沉默无效),
    翼刃(50, 0,SkillTag.沉默无效),
    ...
    英雄之敌(0,15, SkillTag.抗免疫,SkillTag.额外攻击加成),
    头槌破门(90,0, SkillTag.抗免疫,SkillTag.额外攻击加成),
    ...
    召唤幻镜魔导(0, 0, SkillTag.召唤),
    万华镜开始(SkillType.召唤幻镜魔导,0, SkillType.召唤幻镜魔导,0, SkillTag.召唤),
    万华镜(SkillType.万华镜开始,0, SkillType.召唤幻镜魔导,0, SkillTag.召唤),
    页游万华镜(SkillType.万华镜开始,0, SkillType.召唤幻镜魔导,0, SkillTag.召唤),
    纷争乱境(SkillType.无尽华尔兹,0, SkillType.侵蚀,0),
    烈焰之肤(SkillType.护身烈焰,0, SkillType.钢铁之肤,8),
    破阵弧光(0, 0, new int[] { 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200 }, SkillTag.抗免疫, SkillTag.狙击),
    涤罪神启(SkillType.灵魂消散,0, SkillType.祈福,4),
    ...
    夜袭(SkillType.破军,6,SkillType.英雄杀手,8,SkillTag.额外攻击加成),
    利器(SkillType.破军,7,null,0, SkillTag.额外攻击加成),
    ...
    逆战光辉(65,0,SkillType.祈福,9,null,0),
    ...
    清水甘露(300, 0, 3, 0, SkillTag.抗免疫),
    自然之力(2000,0,SkillType.祈福,5,null,0),
    铜墙铁壁(40,0,SkillType.祈福,4,null,0),
    御龙(1,0,SkillTag.抗夺魂),
    御龙在天(0,0,SkillType.铁壁,6,SkillType.御龙,0,SkillTag.抗夺魂),
    心之祈祷(0,0,SkillType.祈愿,2,SkillType.祈福,8),
    妖火降世(SkillType.妖火吐息,0,SkillType.妖火焚烧,0),
    快速成长(SkillType.松鼠吞噬,0,SkillType.恶灵汲取,10),

    百骑袭营(1,0,SkillType.祈愿,2,null,0),
    ...
    游击(0,0,SkillTag.抗夺魂),
    海姆冥界(0,0,SkillTag.抗夺魂),
    迂回(0,0,SkillTag.不动),
    虚实相生(999999,0,SkillTag.抗夺魂),
    周旋(0,0,SkillTag.抗夺魂),
    ...
    棋布星罗(16,0),
    轮换(0),
    失乐园(70,0,SkillTag.抗不屈, SkillTag.魔王无效),
    ...
    轮回天生(100,0,SkillType.归魂,1,null,0),
    重生与希望(70,0,SkillTag.守护),
    鞠躬尽瘁(65,0,SkillTag.抗沉默),
    ...
    剧毒领域(SkillType.毒刃,0,SkillType.吸血,10),
    星阵(SkillType.反射装甲,8,null,0),
    ...
    魔王之怒(4, 0, SkillTag.抗免疫, SkillTag.物理攻击),
    ...
    余音袅袅(SkillType.复活,0,SkillType.灵魂消散,0),
    //手牌添加技能 无判定
    ...
    传承之力(1, 0,SkillType.侵蚀,0,null,0),
    ...
    无畏军旗(SkillType.战意,6,null,0),
    异界神兵(SkillType.神兵,0,null,0),
    ...
    天地大同(4,0,SkillType.不动,0,null,0),
    双飞燕(4,0,SkillType.不动,0,null,0),
    幽思(3,0,SkillType.破魔,0,null,0),
    ...
    弱者退散(0,SkillTag.魔王无效,SkillTag.抗免疫),
    重来(0,SkillTag.魔王无效,SkillTag.抗免疫),
    退散(0,SkillTag.魔王无效,SkillTag.抗免疫),
    震慑(0,SkillTag.魔王无效,SkillTag.抗免疫),
    白虹(300, 0,2400,0, SkillTag.永久, SkillTag.基础攻击加成,SkillTag.魔王无效,SkillTag.抗免疫),
    逐光(0,SkillTag.魔王无效,SkillTag.抗免疫),
    逐光追梦(0,SkillTag.魔王无效,SkillTag.抗免疫),
    杀手回梦(2000,0, SkillTag.额外攻击加成,SkillTag.魔王无效,SkillTag.抗免疫),
    崩坏(0,SkillTag.魔王无效),
    山崩(0,SkillTag.魔王无效),
    ...
    诅咒之刃(5,0,SkillType.诅咒之印,0,null,0),
    //连携技能
    ...
    堕落之印(30,0,SkillTag.抗夺魂),
    魔性变身(50,0,SkillTag.抗夺魂),
    晦月献祭(50, 0),
    ...
    绽放烟花(2,0,1,0,SkillTag.抗免疫, SkillTag.抗不屈, SkillTag.魔王无效, SkillTag.魔族天赋,SkillTag.基础攻击加成),
    ...
    龙吼(2,0, SkillTag.抗免疫,SkillTag.魔王无效),
    琴音共鸣(6,0, SkillTag.抗免疫,SkillTag.魔王无效),
    平沙落雁(3,0, SkillTag.抗免疫,SkillTag.魔王无效,SkillTag.抗沉默),
    ...
    入眠(2,0,3,0,SkillType.魔法装甲,10,null,0, SkillTag.抗免疫,SkillTag.魔王无效),
    厄运缠身(5,0,80,0, SkillTag.抗免疫,SkillTag.魔王无效),
    厄运降临(3,0,60,0, SkillTag.抗免疫,SkillTag.魔王无效),
    断绝之力(2,0,60,0, SkillTag.抗免疫,SkillTag.魔王无效),
    古神的低语(3,0,50,0, SkillTag.抗免疫,SkillTag.魔王无效),
    深渊之力(3,0,0,0, SkillTag.抗免疫,SkillTag.魔王无效),
    ...
    柔光(300,0,SkillType.入眠,0, null,0),
    ...
    吞噬焰火(2,0,1,0,SkillType.焰火改造,0,null,0,SkillTag.抗不屈, SkillTag.魔王无效, SkillTag.魔族天赋),
    ...
    咒怨(2,0,500,0,SkillTag.抗不屈,SkillTag.永久, SkillTag.基础攻击加成, SkillTag.魔王无效,SkillTag.抗夺魂),
    凤凰于飞(2,0,500,0,SkillTag.抗不屈,SkillTag.永久, SkillTag.基础攻击加成, SkillTag.魔王无效),
    ...
    深渊诅咒(2,0,800,0,SkillTag.永久, SkillTag.基础攻击加成, SkillTag.魔王无效),
    ...
    死亡锁链(3,0, SkillTag.抗免疫,SkillTag.魔王无效),
    决胜之心(1,0, SkillTag.抗免疫,SkillTag.魔王无效),
    灵魂锁链(2,0, SkillTag.抗免疫,SkillTag.魔王无效),
    绝望之锁(10,0, SkillTag.抗免疫,SkillTag.魔王无效),
    断绝之翼(5,0, SkillTag.抗免疫,SkillTag.魔王无效),
    燎原之势(2,0, SkillTag.抗免疫,SkillTag.魔王无效),
    形散如烟(3,0,25,0, SkillTag.魔王无效,SkillTag.抗免疫),
    缥缈(1,0,70,0, SkillTag.魔王无效,SkillTag.抗免疫),
    ...
    黑暗魔咒(0, SkillTag.魔王无效, SkillTag.魔族天赋,SkillTag.召唤),
    深情(0),
    长情(0,0,SkillType.深情,0,null,0),
    神鬼之术(750, 0, 3, 0, SkillType.魔力法阵,8,SkillType.威震天下,0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),

    低语集结(3,0,50,0, SkillType.号角,1,null,0,SkillTag.抗免疫,SkillTag.魔王无效),
    道法自然(2,0,SkillType.低语集结,0,SkillType.死亡链接,0, SkillTag.即死),
    幻境(1,0, SkillType.缥缈,0,null,0),
    ...
    不死金身(0),
    举棋若定(0),
    红尘缥缈仙(0,SkillTag.抗沉默),

    //防止技能类型
    稳定(0),
    守如山(0,SkillTag.不动),
    守如山疾(1,0,SkillTag.不动),
    风行(0),
    免疫风行(0),
    ...
    黑暗侵袭(0, 0, 50,0),
    龙斗(400, 0, 60,0,SkillTag.永久, SkillTag.基础攻击加成),
    翼龙之首(SkillType.制裁之拳,0,SkillType.龙斗,0),
    ...
    //契约类
    紧急召集(2,0,SkillTag.召唤),

    //敌方回合发动
    上古神剑(50,0,40,0, SkillTag.抗免疫,SkillTag.魔王无效), //50指发动概率
    三花聚顶(500, 0, 3, 0, SkillTag.抗免疫,SkillTag.魔法,SkillTag.雷系灵轰),

    //移除自身
    追思(0),
    //给对方场上随机卡牌添加技能
    画意相通(3,0,SkillType.追思,0,null,0),

    //守墓类型
    守墓者(3,0,SkillTag.抗夺魂),


    //装备技能
    装备护体(0, 0, new int[] { 0, 10, 25, 40, 40, 40, 40, 40, 40, 40, 40 }),
    装备衰老(0, 0, new int[] { 0, 10, 25, 40, 40, 40, 40, 40, 40, 40, 40 }, SkillTag.抗免疫, SkillTag.永久, SkillTag.基础攻击加成, SkillTag.抗不屈),
    装备裂魂(200, 100, 0, 100, SkillTag.魔法),
    装备噬魂(0,1, new int[] { 0, 300, 500, 600},SkillTag.魔法),
    装备死咒(250,250,0,1),
    装备箭雨(0, 1, new int[] { 0, 350, 450, 600, 600, 600, 600, 600, 600, 600, 600 }, SkillTag.抗免疫, SkillTag.狙击),
    装备操魂(1, 0,0,1),
    装备祈祷(0, 0, new int[] { 0, 400, 1000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000 }),
    装备威压(0,0,2,0, new int[] {0, 100, 200, 500, 500, 500, 500, 500, 500, 500, 500 },SkillTag.永久, SkillTag.基础攻击加成, SkillTag.抗不屈),
    装备过载(SkillType.过载,1,SkillType.过载,3),
    装备强攻(0,1, 装备过载,0,SkillType.过载,5),
    装备呓语(25, 5, SkillTag.控制, SkillTag.魔王无效),
    装备水甲(1350, -150, 300, 100),
    装备魔印(50,0, SkillType.魔力印记,1,null,0),
    装备烙印(150,0,0,1,SkillType.装备魔印,0,null,0),
    装备腐朽(0, 0,new int[] { 0, 10, 25, 40, 40, 40, 40, 40, 40, 40, 40 }, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.魔族天赋),
    装备缚魂(0,1, SkillTag.抗免疫,SkillTag.魔王无效),
    装备纷争(0,1),
    装备祝福(0,0, new int[] { 0, 100, 250, 500, 500, 500, 500, 500, 500, 500, 500 }, SkillTag.基础攻击加成, SkillTag.抗削弱),
    装备护佑(0,0, new int[] { 0, 240, 600, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200 }, SkillTag.抗毒刃),
    装备暴击(SkillType.暴击,1,SkillType.暴击,3),
    装备鼓舞(0,1, 装备暴击,0,SkillType.暴击,5),
    装备月华(0,1,new int[] { 0, 200, 500, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000 }),
    装备流云(0, 0, new int[] { 0, 10, 25, 40, 40, 40, 40, 40, 40, 40, 40 }),
    装备吸收(0, 0, new int[] { 0, 150, 350, 550, 550, 550, 550, 550, 550, 550, 550 }),
    装备逆刃(0, 0, new int[] { 0, 600, 1500, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000 }, SkillTag.抗免疫, SkillTag.反击),
    装备石肤(0, 0, new int[] { 0, 1100, 850, 600, 600, 600, 600, 600, 600, 600, 600 }),
    装备炙炎(0, 0, new int[] { 0, 600, 1500, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000 }),
    装备星辉(0, 0,20,5, new int[] { 0, 150, 200, 250, 250, 250, 250, 250, 250, 250, 250 }, SkillTag.魔法),
    装备绝杀(60,10,550,50, SkillTag.魔法, SkillTag.魔王无效),
...
//    private String wikiId;
    ...
    SkillType(int[] impact3, SkillTag ... tags) {
        this(0, 0, impact3, tags);
    }

    SkillType(int incrImpact, SkillTag ... tags) {
        this(0, incrImpact, tags);
    }

    SkillType(int initImpact, int incrImpact, SkillTag ... tags) {
        this(initImpact, incrImpact, 0, 0, tags);
    }

    SkillType(int initImpact, int incrImpact, int[] impact3, SkillTag ... tags) {
        this(initImpact, incrImpact, 0, 0, impact3, tags);
    }

    SkillType(int initImpact, int incrImpact, int initImpact2, int incrImpact2, SkillTag ... tags) {
        this(initImpact, incrImpact, initImpact2, incrImpact2, null, tags);
    }

    SkillType(int initImpact, int incrImpact, int initImpact2, int incrImpact2, int[] impact3, SkillTag ... tags) {
        this(initImpact, incrImpact, initImpact2, incrImpact2, impact3, null, -1, null, -1, tags);
    }

    SkillType(SkillType attachedType1, SkillType attachedType2, SkillTag ... tags) {
        this(0, 0, 0, 0, null, attachedType1, -1, attachedType2, -1, tags);
    }

    SkillType(SkillType attachedType1, int attachedLevel1, SkillType attachedType2, int attachedLevel2, SkillTag ... tags) {
        this(0, 0, 0, 0, null, attachedType1, attachedLevel1, attachedType2, attachedLevel2, tags);
    }

    SkillType(int initImpact, int incrImpact, SkillType attachedType1, int attachedLevel1, SkillType attachedType2, int attachedLevel2, SkillTag ... tags) {
        this(initImpact, incrImpact,  0, 0, null, attachedType1, attachedLevel1, attachedType2, attachedLevel2, tags);
    }

    SkillType(int initImpact, int incrImpact,int initImpact2, int incrImpact2, SkillType attachedType1, int attachedLevel1, SkillType attachedType2, int attachedLevel2, SkillTag ... tags) {
        this(initImpact, incrImpact,  initImpact2, incrImpact2, null, attachedType1, attachedLevel1, attachedType2, attachedLevel2, tags);
    }

    SkillType(int initImpact, int incrImpact, int initImpact2, int incrImpact2, int[] impact3,
