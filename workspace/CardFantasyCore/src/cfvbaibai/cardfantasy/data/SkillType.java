...
public enum SkillType {
    ...
    独行("", 1, 0),
    空城("",0,0),
    时光倒流("80196", 0, 0, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.新生),
    ...
    幽冥暗影("",0,0, SkillTag.不可洗炼,SkillTag.召唤),
    ...
    勇冠三军("",4,0,60,0, SkillTag.不可洗炼,SkillTag.基础攻击加成),
    ...
    魔王之怒("", 4, 0, SkillTag.抗免疫, SkillTag.物理攻击, SkillTag.不可洗炼),
    ...
    //神谕
    神谕("", 3, 0, SkillTag.不可洗炼),

    //装备技能
    装备护体("", 0, 0, new int[] { 0, 10, 25, 40, 40, 40, 40, 40, 40, 40, 40 }, SkillTag.不可洗炼),
    装备衰老("", 0, 0, new int[] { 0, 10, 25, 40, 40, 40, 40, 40, 40, 40, 40 }, SkillTag.抗免疫, SkillTag.永久, SkillTag.基础攻击加成, SkillTag.抗不屈, SkillTag.不可洗炼),
    装备裂魂("", 200, 100, 0, 100, SkillTag.魔法, SkillTag.不可洗炼),
    装备噬魂("", 0,1, new int[] { 0, 300, 500, 600},SkillTag.魔法, SkillTag.不可洗炼),
    装备死咒("", 250,250,0,1, SkillTag.不可洗炼),
    装备箭雨("", 0, 1, new int[] { 0, 350, 450, 600, 600, 600, 600, 600, 600, 600, 600 }, SkillTag.抗免疫, SkillTag.狙击, SkillTag.不可洗炼),
    装备操魂("", 1, 0,0,1, SkillTag.不可洗炼),
    装备祈祷("", 0, 0, new int[] { 0, 400, 1000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000 }, SkillTag.不可洗炼),
    装备威压("", 0,0,2,0, new int[] {0, 100, 200, 500, 500, 500, 500, 500, 500, 500, 500 },SkillTag.永久, SkillTag.基础攻击加成, SkillTag.抗不屈, SkillTag.不可洗炼),
    装备过载("",SkillType.过载,1,SkillType.过载,3, SkillTag.不可洗炼),
    装备强攻("",0,1, 装备过载,0,SkillType.过载,5, SkillTag.不可洗炼),
    装备呓语("", 25, 5, SkillTag.控制, SkillTag.魔王无效, SkillTag.不可洗炼),
    装备水甲("", 1350, -150, 300, 100, SkillTag.不可洗炼),
    装备魔印("",50,0, SkillType.魔力印记,1,null,0, SkillTag.不可洗炼),
    装备烙印("", 150,0,0,1,SkillType.装备魔印,0,null,0, SkillTag.不可洗炼),
    装备腐朽("", 0, 0,new int[] { 0, 10, 25, 40, 40, 40, 40, 40, 40, 40, 40 }, SkillTag.抗免疫, SkillTag.魔王无效, SkillTag.魔族天赋, SkillTag.不可洗炼),
    装备缚魂("",0,1, SkillTag.抗免疫,SkillTag.魔王无效, SkillTag.不可洗炼),
    装备纷争("", 0,1, SkillTag.不可洗炼),
    装备祝福("", 0,0, new int[] { 0, 100, 250, 500, 500, 500, 500, 500, 500, 500, 500 }, SkillTag.基础攻击加成, SkillTag.抗削弱, SkillTag.不可洗炼),
    装备护佑("", 0,0, new int[] { 0, 240, 600, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200 }, SkillTag.抗毒刃, SkillTag.不可洗炼),
    装备暴击("",SkillType.暴击,1,SkillType.暴击,3, SkillTag.不可洗炼),
    装备鼓舞("",0,1, 装备暴击,0,SkillType.暴击,5, SkillTag.不可洗炼),
    装备月华("",0,1,new int[] { 0, 200, 500, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000 }, SkillTag.不可洗炼),
    装备流云("", 0, 0, new int[] { 0, 10, 25, 40, 40, 40, 40, 40, 40, 40, 40 }, SkillTag.不可洗炼),
    装备吸收("", 0, 0, new int[] { 0, 150, 350, 550, 550, 550, 550, 550, 550, 550, 550 }, SkillTag.不可洗炼),
    装备逆刃("", 0, 0, new int[] { 0, 600, 1500, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000 }, SkillTag.抗免疫, SkillTag.反击,SkillTag.不可洗炼),
    装备石肤("", 0, 0, new int[] { 0, 1100, 850, 600, 600, 600, 600, 600, 600, 600, 600 }, SkillTag.不可洗炼),
    装备炙炎("", 0, 0, new int[] { 0, 600, 1500, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000 }, SkillTag.不可洗炼),
    装备星辉("", 0, 0,20,5, new int[] { 0, 150, 200, 250, 250, 250, 250, 250, 250, 250, 250 }, SkillTag.不可洗炼, SkillTag.魔法),
